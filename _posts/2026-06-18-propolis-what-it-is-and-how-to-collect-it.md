...
**Propolis scraper:** A dedicated stainless steel scraper is worth picking up even though a putty knife works. The beveled edge is sharper, the handle is designed for hive work, and the cost is low. Grab a [stainless steel propolis scraper tool](https://www.amazon.com/dp/B0957KQL3N?tag=mbbeekeeping-20) if you're planning repeated harvests.
...
**Propolis trap:** If you want to harvest without scraping frames, invest in a [propolis trap collector](https://www.amazon.com/dp/B0BY9XL7RJ?tag=mbbeekeeping-20). The upfront cost is higher, but yield is better and the work is less invasive. A quality trap runs $25-45 and lasts multiple seasons.
...
1. Time your collection for cool weather. Propolis becomes tacky above 75-80 degrees Fahrenheit, making it stick to your tools rather than flake off. Spring and fall are ideal. Early morning or late afternoon inspections yield better results than midday heat.

2. Inspect the hive for propolis accumulation. Look at the inner cover, the top bars of frames, and the walls of your boxes. Dense propolis buildup on the inner cover is common in strong colonies. Mark mentally which surfaces have the thickest coating.

3. Use a propolis scraper or cold putty knife to work the surface. A dedicated [stainless steel propolis scraper tool](https://www.amazon.com/dp/B0957KQL3N?tag=mbbeekeeping-20) makes this easier, but any flat metal tool with a beveled edge works. Start at one corner and work horizontally or vertically in deliberate strokes. Don't dig; let the tool glide over the surface and flake propolis away. Bees will quickly rebuild what you remove - you're not harming the colony.

4. Collect flakes into a clean container. A stainless steel or glass bowl catches flakes easily. Propolis will stick to plastic, so avoid plastic collection containers.

5. Bring the container indoors and place it in your freezer for 2-3 hours. Cold makes propolis brittle. Once frozen, it separates from any embedded debris, wax, or wood fibers more easily. You can crumble it by hand and use a small sieve or fine strainer to shake out unwanted material.

6. Store frozen propolis in a sealed glass jar. It keeps indefinitely when frozen and maintains potency. Thaw only what you plan to use immediately, as propolis can re-absorb moisture if exposed to air after freezing.
...
The [propolis trap collector](https://www.amazon.com/dp/B0BY9XL7RJ?tag=mbbeekeeping-20) units available online simplify this process significantly. They sit directly under the inner cover, have removable sections, and freeze solid for easy harvest. In a strong hive during active season, traps yield 20-100 grams of propolis over 4-6 weeks. Some keepers run multiple traps on a single hive.

1. Place the trap on top of the frames, centered directly under the inner cover. Make sure it sits flush so bees perceive the openings as genuine gaps.

2. Leave the trap undisturbed for 3-4 weeks. Bees work gradually. Rushing the timing means lower yield.

3. Remove the trap during a warm afternoon when bees are out foraging. Less propolis on the trap means less guard bee attention. Work quickly and smoothly.

4. Place the trap in a freezer for 24 hours. Full freezing makes propolis shatter rather than crack.

5. Pop the trap out and snap the hardened propolis into chunks. Flexible trap materials will crack along the propolis layer. You'll harvest concentrated propolis with minimal debris.

6. Screen the chunks to remove any plastic fragments. A fine mesh strainer works well.
...
A: Yes, but proper extraction takes time. Soak cleaned, chopped propolis in high-proof alcohol for 2-3 weeks at room temperature, shaking the jar daily. Strain through coffee filters and discard the solids. The resulting tincture keeps indefinitely and is ready to use as a sore throat rinse or immune support supplement. If you prefer a finished product without the extraction work, commercial [organic propolis tincture extracts](https://www.amazon.com/dp/B0CNQMXG2Q?tag=mbbeekeeping-20) are available and worth comparing for convenience.
...
Once you've harvested honey successfully, propolis is the next logical byproduct to explore. The techniques are straightforward, the tools are affordable, and the result is something genuinely useful. Check out the guide on [how to harvest honey for the first time](/2026-03-20-how-to-harvest-honey-for-the-first-time) if you want to sequence your learning - honey typically comes first, propolis collection develops naturally once you're comfortable with hive access and frame handling.

## Additional Resources

For more on handling propolis in the apiary, [Mann Lake's honey and propolis handling guide](https://www.mannlakeltd.com/honey-and-propolis-handling) covers best practices for both extraction and storage. If you're looking for other specialty hive equipment, [Dadant's apiary supplies section](https://www.dadant.com/supplies-apiary-equipment) stocks both standard and specialized tools.

The scientific foundation for propolis benefits is stronger than folklore alone. The [Journal of Phytotherapy Research](https://www.wileyonlinelibrary.com/journal/ptr) publishes regular systematic reviews of propolis research, and the [NIH's PubMed database](https://pubmed.ncbi.nlm.nih.gov/) allows free access to abstract data on propolis pharmacology and efficacy studies.
